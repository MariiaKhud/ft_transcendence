...
color_echo "$BLUE" "31d. DELETE /api/users/me/cv — remove CV and reject unauthenticated requests"
...
perform_request "Public profile without CV" "${BASE_URL}/api/users/${USERNAME}"
assert_status "200" "Public profile without CV"
assert_body_contains '"cvUrl":null' "Public profile without CV"
assert_body_contains '"cvFilename":null' "Public profile without CV"
